...
export default function FullWidthTabs() {
  ...
  const displayedCertificates = showAllCertificates ? HARDCODED_CERTIFICATES : HARDCODED_CERTIFICATES.slice(0, initialItems);
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          {/* Projects Tab - Still connected to Firebase */}
          ...
          {/* Certificates Tab - Now using hardcoded data */}
          <TabPanel value={value} index={1} dir={theme.direction}>
            ...
            {HARDCODED_CERTIFICATES.length > initialItems && (
              <div className="mt-6 w-full flex justify-start">
                <ToggleButton
